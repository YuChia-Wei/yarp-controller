...
public sealed record ForwarderRequestConfig
{
    ...
    public bool Equals(ForwarderRequestConfig? other)
    {
        ...
        return this.ActivityTimeout == other.ActivityTimeout
               && this.VersionPolicy == other.VersionPolicy
               && this.Version == other.Version
               && this.AllowResponseBuffering == other.AllowResponseBuffering;
    }

    public override int GetHashCode()
    {
        return HashCode.Combine(this.ActivityTimeout, this.VersionPolicy, this.Version, this.AllowResponseBuffering);
    }
}
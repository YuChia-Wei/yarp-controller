...
public static class CollectionEqualityHelper
{
    ...
    public static bool Equals<T>(
        IReadOnlyDictionary<string, T>? dictionary1,
        IReadOnlyDictionary<string, T>? dictionary2,
    ...
    public static bool Equals<T>(
        IReadOnlyList<IReadOnlyDictionary<string, T>>? dictionaryList1,
        IReadOnlyList<IReadOnlyDictionary<string, T>>? dictionaryList2,
        IEqualityComparer<T>? valueComparer = null)
    {
